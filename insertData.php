...
// $sql20 = "INSERT INTO PLACES VALUES(NULL,'Germia National Park','A cool place to spend a Sunday','Rr. Dr. Shpetim Robaj','Prishtine',2);
// INSERT INTO PLACES VALUES(NULL,'Prizren\'s Castle','A cool place to explore','Kalaja','Prizren',3);
// INSERT INTO PLACES VALUES(NULL,'Mirusha Waterfalls','A cool natural phenomenon','Llapçeve','Malisheve',4);
// INSERT INTO PLACES VALUES(NULL,'White Drin','A cool place to visit','Radavc','Peje',5);
// INSERT INTO PLACES VALUES(NULL,'Gadime Cave','A cool place to know','Gadime e Poshtme','Lipjan',9);
// INSERT INTO PLACES VALUES(NULL,'Brezovica Mountain','Weekends in Winter','Shterpce','Shterpce',8);
// INSERT INTO PLACES VALUES(NULL,'Rugova Canyon','A cool place to spend a Sunday','Peje','Peje',5);
// INSERT INTO PLACES VALUES(NULL,'Prevalla','A cool place to walk','Prizren','Prizren',2);";
...
// $sql21 = "INSERT INTO SERVICES VALUES(NULL,'Sunny Hill Festival','Festivals');
// INSERT INTO SERVICES VALUES(NULL,'Pri Film Fest','Festivals');
// INSERT INTO SERVICES VALUES(NULL,'The Lily of Prizren','Festivals');
// INSERT INTO SERVICES VALUES(NULL,'17 February','Events');
// INSERT INTO SERVICES VALUES(NULL,'Prite n\'Shesh','Events');
// INSERT INTO SERVICES VALUES(NULL,'DOKUTECH','Events');
// INSERT INTO SERVICES VALUES(NULL,'Lidhja e Prizrenit','Monuments');
// INSERT INTO SERVICES VALUES(NULL,'Mosque of Sinan Pasha','Monuments');
// INSERT INTO SERVICES VALUES(NULL,'National Museum of Kosovo','Monuments');
// INSERT INTO SERVICES VALUES(NULL,'Famous restaurants in Prishtina','Food And Drink');
// INSERT INTO SERVICES VALUES(NULL,'Famous restaurants in Prizren','Food And Drink');
// INSERT INTO SERVICES VALUES(NULL,'Famous restaurants in Peja','Food And Drink');";
...
// INSERT INTO TOUR VALUES(NULL,'images/Services/sunnyhill1','Sunny Hill Festival\'s queen','SUNNY HILL Festival is the biggest festival organized in Kosovo.',4);
...
// INSERT INTO TOUR VALUES(NULL,'images/Services/sunnyhill5','It\'s all about having fun... and seeing stars','From New York to London, from Milan to Sao Paulo and New Delhi to Los Angeles, Sunny Hill Festival was a sensation everyone from all corners of the world was talking about and an event that thousands and thousands wanted to experience.',4);
...
// INSERT INTO TOUR VALUES(NULL,'images/Services/kosova2.jpg','Kosovo National Team','Manned mostly with young players from Kosovo\'s diaspora, the team is a powerful symbol of the 1.8 million Kosovars\' campaign for respect abroad, due in part to the importance that Pristina has long attached to sports and culture to buttress its efforts for international recognition.',7);
// INSERT INTO TOUR VALUES(NULL,'images/Services/kosova3.jpg','Kosovo Flag','The flag displays six white stars in an arc above a golden map of Kosovo on a blue field. They are officially meant to symbolize Kosovo\'s six major ethnic groups: Albanians, Serbs, Turks, Gorani, Roma and Bosniaks.',7);
...
// INSERT INTO TOUR VALUES(NULL,'images/Services/kosova5.jpg','Kosovo Army','The KSF will for the first time this year overtake the capital\'s squares with a new military mission. Force Day will be an open day where citizens will be able to see closely their army with new mandates. It will also present new emblems for the KSF units.',7);
...
// INSERT INTO TOUR VALUES(NULL,'images/Services/prite1.jpg','Magic moments','This year\'s \'Cut to the Square\' has not only been one night as it was in previous years, but has been full of 27 nights.',8);
...
// INSERT INTO TOUR VALUES(NULL,'images/Services/prite7.jpg','Vere n\'Dimen','Year-end holidays are making even the best small wooden houses located in Zahir Pajaziti Square in Pristina. These houses where citizens can spend their time and serve hot drinks are staying open daily from morning till midnight, in the framework of Vere nDimen activity',8);
